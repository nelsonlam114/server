...
var mongourl = 'mongodb://test:test@ds119588.mlab.com:19588/testnelsondb233';
...
app.get("/update", function(req,res) {
    MongoClient.connect(mongourl, function(err, db) {
	   ...
	   find2restaurant(db,criteria,function(restaurant) {
	      db.close();
	      console.log('Disconnected MongoDB\n');
       	res.render('update2',{r:restaurant,_id:criteria});
        res.end();
	    });
	  });
});

function find2restaurant(db,criteria,callback) {
...
app.get('/delete', function(req,res){
	MongoClient.connect(mongourl, function(err, db) {
		...
		var criteria = {"_id": ObjectId(req.query._id)};
		console.log(criteria);
	    del1restaurant(db,criteria,function(restaurant) {
	      db.close();
	      console.log('Disconnected MongoDB\n');
       	res.render('delete',{r:restaurant,_id:criteria});
        res.end();
	    });
	  });
});
function del1restaurant(db,criteria,callback) {
